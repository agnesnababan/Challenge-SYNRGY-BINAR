...
const inputManufacture = document.getElementsByName('manufacture');
...
function searchCarBasedManufacture() {
  ...
  const searchManufacture = carInventory.filter((car) =>
    car.manufacture.toLowerCase().includes(searchInput.toLowerCase())
  );
...
searchManufactureButton.addEventListener('submit', searchCarBasedManufacture);